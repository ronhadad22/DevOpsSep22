...
curl  -X POST \http://ec2-54-207-102-47.sa-east-1.compute.amazonaws.com:8081/clienthello \ -H 'Content-Type: application/json' \-d '{"clientVersion": "3.2", "message": "Client Hello"}' | jq '.' > response.json
